...
if(no==2)
{
      out.write("\r\n");
      out.write("<div class=\"gradientbuttons\" id=\"message\" style=\"position:absolute;top:0px;left:280px\">\r\n");
      out.write("\t<p>OOP's Your Old Password is Wrong ...!!</p>\r\n");
      out.write("</div>\r\n");
}
if(no==3)
{
	...
	while(rs.next())
	{
      ...
      out.print(request.getContextPath() );
      out.write("/ChangePass1\" method=\"post\">\r\n");
      out.write("<input class=\"gradientbuttons\" type=\"submit\" value=\"Change Password\" class=\"gradientbuttons\" ></input>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div>\r\n");
