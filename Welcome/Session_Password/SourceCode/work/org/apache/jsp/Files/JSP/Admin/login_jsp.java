...
if(no==1)
{
      ...
      out.write("\t    <h1>");
      out.print(pro.getProperty("LoginHeader_A") );
      out.write("</h1>\r\n");
      out.write("    \t<div>\r\n");
      out.write("    \t\t");
      out.print(pro.getProperty("T1_A") );
      out.write("\r\n");
      out.write("    \t\t<input type=\"text\" name=\"username\" id=\"login_username\" required=\"yes\"  />\r\n");
      out.write("    \t</div>\t\t\t\r\n");
      out.write("\t    <div>\r\n");
      out.write("    \t\t");
      out.print(pro.getProperty("T2_A") );
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("    \t\t<input type=\"password\" name=\"password\" id=\"login_password\" required=\"yes\"  />\r\n");
      out.write("    \t</div>\t\t\t\r\n");
      out.write("\t\t<p class=\"forgot\"><a href=\"#\">");
      out.print(pro.getProperty("Forget") );
      out.write("</a></p>\r\n");
