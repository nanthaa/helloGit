...
{
      out.write("\r\n");
      out.write("<div class=\"gradientbuttons\" id=\"message\" style=\"position:absolute;top:0px;left:280px\">\r\n");
...
if(no==2)
{
	...
	while(rs.next())
	{
      ...
      out.print(request.getContextPath() );
      out.write("/UpdateProfile1\" method=\"post\">\r\n");
      out.write("<input class=\"gradientbuttons\" type=\"submit\" value=\"Update Changes\" class=\"gradientbuttons\" ></input>\r\n");
      out.write("\r\n");
      out.write("<div>\r\n");
      ...
      out.print(city );
      out.write("\"></input></p>\r\n");
      out.write("\t<p id=\"al\">Your Sate : <input type=\"text\" name=\"state\" value=\"");
      out.print(state );
      out.write("\"></input></p>\r\n");
      out.write("</div>\r\n");
      out.write("</form>\r\n");
