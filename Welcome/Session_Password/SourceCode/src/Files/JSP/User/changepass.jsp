...
{%>
<div class="gradientbuttons" id="message" style="position:absolute;top:0px;left:280px">
	<p>OOP's Your Old Password is Wrong ...!!</p>
</div>
<%}
if(no==3)
{%>
...
<br></br>
<form action="<%=request.getContextPath() %>/ChangePass1" method="post">
<input class="gradientbuttons" type="submit" value="Change Password" class="gradientbuttons" ></input>
